...
export default function VistaEnDesarrollo({ cambiarVista }) {
  return (
    <Box sx={{ p: 4 }}>
      {/* Botones de navegación */}
      <Box display="flex" justifyContent="center" mb={4}>
      ...
      >
        <ConstructionIcon
          sx={{ fontSize: 60, color: "orange", mb: 2 }}
        />
        <Typography variant="h5" fontWeight="bold" gutterBottom>
          Página en Desarrollo 🚧
        </Typography>
        <Typography variant="body1" color="text.secondary">
          Esta sección está siendo desarrollada para incluir las siguientes funciones:
        </Typography>
        <Box component="ul" sx={{ textAlign: "left", mt: 2, ml: 3 }}>
          <li>Consulta de ventas para cancelar o devolver</li>
          <li>Cancelación total o parcial de tickets</li>
          <li>Devolución de productos con control de inventario</li>
          <li>Visualización e impresión del ticket modificado</li>
          <li>Control de estatus: pagado, cancelado, devuelto, parcial</li>
          <li>Mejoras visuales y filtros avanzados</li>
        </Box>
        <Typography variant="body2" mt={3} color="text.secondary">
          Pronto estará disponible para su uso. ¡Gracias por tu paciencia!
        </Typography>
      </Paper>
    </Box>
  );
