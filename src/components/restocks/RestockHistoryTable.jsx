...
import RestockPdfViewerModal from "./RestockPdfViewerModal";
...
export default function RestockHistoryTable({ rows = [], loading = false }) {
          ...
          >
            <Stack spacing={1} alignItems="center">
              ...
              >
                ...
                entrada, producto, descripción, fecha, cantidad, costo y PDF.
              </Typography>
            </Stack>
          </Box>
        ) : (
