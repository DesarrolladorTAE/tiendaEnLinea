  ...
  return (
    ...
    >
      <Stack spacing={2} alignItems="center">
        <ConstructionRoundedIcon sx={{ fontSize: 50, opacity: 0.6 }} />
        ...
        <Typography variant="body2" sx={{ opacity: 0.75, maxWidth: 420 }}>
          Estamos trabajando en esta sección para que puedas crear y gestionar
          cupones de descuento con reglas avanzadas por productos, categorías,
          variantes y más.
        </Typography>

        <Alert severity="info" sx={{ maxWidth: 420 }}>
          🚀 Próximamente estará disponible en una próxima actualización.
        </Alert>
      </Stack>
    </Paper>
  );
