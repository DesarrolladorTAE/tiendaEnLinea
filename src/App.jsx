...
const HomeFurnitureThree = lazy(() => import("./pages/home/HomeFurnitureThree.jsx"));
...
const HomeFurnitureSeven = lazy(() => import("./pages/home/HomeFurnitureSeven.jsx"));
const HomeElectronics = lazy(() => import("./pages/home/HomeElectronics.jsx"));
const HomeElectronicsTwo = lazy(() => import("./pages/home/HomeElectronicsTwo.jsx"));
const HomeElectronicsThree = lazy(() => import("./pages/home/HomeElectronicsThree.jsx"));
...
const HomeOrganicFoodTwo = lazy(() => import("./pages/home/HomeOrganicFoodTwo.jsx"));
...
const HomeMedicalEquipment = lazy(() => import("./pages/home/HomeMedicalEquipment.jsx"));
...
const ProductTabLeft = lazy(() => import("./pages/shop-product/ProductTabLeft.jsx"));
const ProductTabRight = lazy(() => import("./pages/shop-product/ProductTabRight.jsx"));
...
const ProductFixedImage = lazy(() => import("./pages/shop-product/ProductFixedImage.jsx"));
...
const BlogDetailsStandard = lazy(() => import("./pages/blog/BlogDetailsStandard.jsx"));
      ...
      <ScrollToTop>
        ...
        >
          <Routes>
            ...
            <Route path={"/home-fashion-seven"} element={<HomeFashionSeven />} />
            <Route path={"/home-fashion-eight"} element={<HomeFashionEight />} />
            ...
            <Route path={"/home-furniture-two"} element={<HomeFurnitureTwo />} />
            <Route path={"/home-furniture-three"} element={<HomeFurnitureThree />} />
            <Route path={"/home-furniture-four"} element={<HomeFurnitureFour />} />
            <Route path={"/home-furniture-five"} element={<HomeFurnitureFive />} />
            <Route path={"/home-furniture-six"} element={<HomeFurnitureSix />} />
            <Route path={"/home-furniture-seven"} element={<HomeFurnitureSeven />} />
            <Route path={"/home-electronics"} element={<HomeElectronics />} />
            <Route path={"/home-electronics-two"} element={<HomeElectronicsTwo />} />
            <Route path={"/home-electronics-three"} element={<HomeElectronicsThree />} />
            <Route path={"/home-book-store"} element={<HomeBookStore />} />
            <Route path={"/home-book-store-two"} element={<HomeBookStoreTwo />} />
            <Route path={"/home-plants"} element={<HomePlants />} />
            <Route path={"/home-flower-shop"} element={<HomeFlowerShop />} />
            <Route path={"/home-flower-shop-two"} element={<HomeFlowerShopTwo />} />
            <Route path={"/home-organic-food"} element={<HomeOrganicFood />} />
            <Route path={"/home-organic-food-two"} element={<HomeOrganicFoodTwo />} />
            <Route path={"/home-onepage-scroll"} element={<HomeOnepageScroll />} />
            ...
            <Route path={"/home-medical-equipment"} element={<HomeMedicalEquipment />} />
            <Route path={"/home-christmas"} element={<HomeChristmas />} />
            <Route path={"/home-black-friday"} element={<HomeBlackFriday />} />
            <Route path={"/home-black-friday-two"} element={<HomeBlackFridayTwo />} />
            <Route path={"/home-valentines-day"} element={<HomeValentinesDay />} />

            {/* Shop pages */}
            <Route path={"/shop-grid-standard"} element={<ShopGridStandard />} />
            <Route path={"/shop-grid-filter"} element={<ShopGridFilter />} />
            <Route path={"/shop-grid-two-column"} element={<ShopGridTwoColumn />} />
            <Route path={"/shop-grid-no-sidebar"} element={<ShopGridNoSidebar />} />
            <Route path={"/shop-grid-full-width"} element={<ShopGridFullWidth />} />
            <Route path={"/shop-grid-right-sidebar"} element={<ShopGridRightSidebar />} />
            <Route path={"/shop-list-standard"} element={<ShopListStandard />} />
            <Route path={"/shop-list-full-width"} element={<ShopListFullWidth />} />
            <Route path={"/shop-list-two-column"} element={<ShopListTwoColumn />} />
